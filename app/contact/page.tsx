  ...
  return (
    <div className="mx-auto w-full max-w-135 flex flex-col items-center font-mono gap-8.25 py-3.75 lg:max-w-200 xl:max-w-250 xl:gap-10 xl:py-10">
      <div className="w-full flex flex-col items-center gap-9 sm:flex-row sm:justify-between">
        ...
        <img src="/logo/logo-sm.svg" alt="Logo" className="w-28 sm:mr-7 lg:w-44.5 xl:w-59.25" />
      </div>
      <p className="text-xs w-full lg:text-sm xl:text-base">blah blah blah words go here blah blah words go here blah blah words go here blah blah words go here blah blah words go here blah blah words go here blah. blah words go here bl blah words go here bl.</p>
