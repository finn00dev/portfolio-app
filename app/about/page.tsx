  ...
  return (
    <div className="flex flex-col pb-5 gap-3.5 sm:gap-5">
      ...
      <div className="flex flex-col items-center lg:flex-row lg:gap-7.5 lg:justify-center lg:items-start xl:gap-10">
        <div className="max-w-135 flex flex-col w-full gap-4.5 md:max-w-152.5 md:gap-6.5 lg:w-120 xl:w-137.5">
          <img src="/about/about.jpg"  alt="Finn" className="object-cover w-full" />
          
          <div className="flex items-center gap-5">
            <span className="font-sans text-4xl italic md:text-5xl xl:text-6xl">Hey, I'm Finn</span>
            <div className="flex-1 h-[1.5px] bg-current"></div>
          </div>

          <p className="font-mono text-[11px] mb-3.5 md:text-sm xl:text-base">
